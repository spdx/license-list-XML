...
Please see [DOCS](https://github.com/spdx/license-list-XML/blob/master/DOCS) and [CONTRIBUTING.md](https://github.com/spdx/license-list-XML/blob/master/CONTRIBUTING.md) for more information.
