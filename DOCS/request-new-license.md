...
1.  Review the [license inclusion principles](license-inclusion-principles.md). Please refrain from submitting licenses that clearly do not meet these principles, for example, a license for which the text is not finalized or is only used on your personal project.
...
3. If accepted, the new license or exception files will be need to be prepared via a Pull Request: a plain text test file should be UTF-8 encoded and match the text and formatting of the original license; and an XML file with the appropriate specific tags. 
...
Note: If a license is *not* accepted for inclusion on the SPDX License List, you can use the 'LicenseRef-[idstring]' tag to identify your license, as per [SPDX specification, clause 10]([https://spdx.github.io/spdx-spec/6-other-licensing-information-detected/](https://spdx.github.io/spdx-spec/v2.3/other-licensing-information-detected/))
