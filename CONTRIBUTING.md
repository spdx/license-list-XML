...
5. The new license/exception will be officially added for the next release of the SPDX License List. SPDX License List releases are done on quarterly basis (more or less).
